...
class lesson1_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lesson1_1")
        ...
        self.lpf_decim = lpf_decim = int(samp_rate/channel_width)
        self.gain = gain = 20
        ...
        self.top_grid_layout.addWidget(self._volume_win, 4, 1, 1, 1)
        for r in range(4, 5):
        ...
        self.top_grid_layout.addWidget(self._cutoff_freq_win, 3, 1, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._channel_freq_win, 2, 0, 1, 2)
        for r in range(2, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._bandwidth_win, 3, 0, 1, 1)
        for r in range(3, 4):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_x_0_1_win, 0, 1, 1, 1)
        for r in range(0, 1):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(1, 2):
            self.top_grid_layout.setColumnStretch(c, 1)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.set_lpf_decim(int(self.samp_rate/self.channel_width))
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, self.cutoff_freq, 20e3, window.WIN_HAMMING, 6.76))
        self.qtgui_freq_sink_x_0_1.set_frequency_range(self.channel_freq, (self.samp_rate/self.lpf_decim))
...
def main(top_block_cls=lesson1_1, options=None):
