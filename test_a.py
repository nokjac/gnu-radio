...
class test_a(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "test_a")
        ...
        # Blocks
        ##################################################
        self._freq_range = Range(88e6, 108e6, 10e3, 88e6, 200)
...
def main(top_block_cls=test_a, options=None):
