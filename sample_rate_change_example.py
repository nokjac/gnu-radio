...
# Author: jkita
# Description: Interpolation is the process of increasing the sampling rate and thus the available bandwidth. This example demonstrates how to increase the sampling rate using the Interpolating FIR Filter block.
...
class sample_rate_change_example(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "sample_rate_change_example")
        ...
        self.low_pass_filter_taps = low_pass_filter_taps = firdes.low_pass(1.0, samp_rate_interpolated, samp_rate_interpolated/(interpolation_rate*2),20e3, window.WIN_HAMMING, 6.76)
        self.freq = freq = 0
        ...
        self._freq_range = Range(0, 10e6, 100, 0, 200)
    ...
    def set_interpolation_rate(self, interpolation_rate):
        ...
        self.set_low_pass_filter_taps(firdes.low_pass(1.0, self.samp_rate_interpolated, self.samp_rate_interpolated/(self.interpolation_rate*2), 20e3, window.WIN_HAMMING, 6.76))
        self.set_samp_rate_interpolated(self.samp_rate*self.interpolation_rate)
...
def main(top_block_cls=sample_rate_change_example, options=None):
